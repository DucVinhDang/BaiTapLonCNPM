				...
				<div class="form-group">
				    ...
				    <div class="col-md-10">
				        <select class="form-control" name="editgvgioitinh">
				        	<?php echo'<option value="1"'; if($result["gv_gioitinh"]==1) { echo 'selected'; }  echo'>Trai</option>'; ?>;
				        	<?php echo'<option value="2"'; if($result["gv_gioitinh"]==2) { echo 'selected'; }  echo'>Gái</option>'; ?>;
				    	</select>
				    </div>
				</div>
				<div class="form-group">
