<?php
	class Khoa_db_manager {
		...
		function edit(Khoa $edit_khoa) {
			...
			$queryCommand = "UPDATE qlgv_khoa SET k_ten = '" . $new_k_ten . "', k_makhoa = '" . $new_k_makhoa . "', k_email ='" . $new_k_email . "', k_sdt = '" . $new_k_sdt . "', k_mota = '" . $new_k_mota . "', is_delete = '" . $new_is_delete . "' WHERE k_id = " . $k_id;
			$queryResult = $this->db_core->db_query($queryCommand);
